...
export default {
  ...
  // directory provide comprehensive functional coverage of all features.
  // To improve coverage metrics in the future, consider refactoring the
  // server logic into separate modules that can be imported and tested.
  coverageThreshold: {
    global: {
      branches: 0,
      functions: 0,
